...
class Events:
    ...
    def response(self, flow: mitmproxy.http.HTTPFlow):
        ...
        """
        #ctx.log.info("========= response ========= \n{}".format(json.loads(flow.response.data.content)))
    ...
    def websocket_message(self, flow: mitmproxy.websocket.WebSocketFlow):
        ...
        for flow_msg in flow.messages:
            ...
            ctx.log.info("[" + ("Sended" if from_client else "Reveived") + "]: decode the packet here: %r…" % packet)
